...
- Features to add: connection maanger, ability to open a connectikon with a config file (xml or json) or command line parameters
- all screenshots are in  /Users/rmpel/Development/SwiftDB/SwiftDB/issues